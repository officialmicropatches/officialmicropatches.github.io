...
const PRODUCT_DATA = Object.freeze({
  "az-dps":                   { name: "Arizona Department of Public Safety", location: "Statewide, AZ", category: "Law Enforcement", description: "The Arizona DPS — AZ State Troopers — serve the entire state. This collector keychain replicates the iconic AZ DPS shoulder patch in precise UV-printed detail." },
  "auburn-pd-retired":        { name: "Auburn Police Department Retired", location: "Auburn, WA", category: "Law Enforcement", description: "Honoring the men and women who dedicated their career to Auburn, Washington. This retired edition features the Auburn PD patch in full collector detail." },
  "chandler-pd":              { name: "Chandler Police Department", location: "Chandler, AZ", category: "Law Enforcement", description: "Representing one of the fastest-growing cities in the country. The Chandler PD patch keychain is a popular collector item for officers and supporters in the East Valley." },
  "chandler-pd-retired":      { name: "Chandler Police Department Retired", location: "Chandler, AZ", category: "Law Enforcement", description: "A tribute to career service. The Chandler PD Retired edition is ideal for officers who've earned their badge and the right to carry it in style." },
  "chicago-pd":               { name: "Chicago Police Department", location: "Chicago, IL", category: "Law Enforcement", description: "One of the most recognized police patches in the world. The Chicago PD collector keychain is a bold tribute to the men and women of the CPD." },
  "surprise-pd":              { name: "City of Surprise Police Department", location: "Surprise, AZ", category: "Law Enforcement", description: "Surprise PD protects one of Arizona's most rapidly expanding communities. This keychain captures their distinctive patch in vivid UV-printed color." },
  "el-mirage-pd":             { name: "El Mirage Police Department", location: "El Mirage, AZ", category: "Law Enforcement", description: "Small city, big pride. The El Mirage PD patch keychain is a hand-finished collector piece for supporters of this West Valley agency." },
  "florida-hp":               { name: "Florida Highway Patrol", location: "Statewide, FL", category: "Law Enforcement", description: "Florida's finest on patrol. The FHP patch keychain features the iconic Florida Highway Patrol shoulder patch reproduced in precise micro detail." },
  "gila-river-pd":            { name: "Gila River Indian Police Department", location: "Gila River, AZ", category: "Law Enforcement", description: "Serving the Gila River Indian Community in Arizona, this keychain honors the officers who protect and serve tribal lands with dedication." },
  "gilbert-pd":               { name: "Gilbert Police Department", location: "Gilbert, AZ", category: "Law Enforcement", description: "Gilbert PD serves one of the safest large cities in America. This East Valley collector patch keychain is a great gift for officers and supporters alike." },
  "goodyear-pd-retired":      { name: "Goodyear Police Department Retired", location: "Goodyear, AZ", category: "Law Enforcement", description: "Celebrating career service in Arizona's growing West Valley. The Goodyear PD Retired edition is a perfect keepsake for officers hanging up the badge." },
  "honolulu-pd":              { name: "Honolulu Police Department", location: "Honolulu, HI", category: "Law Enforcement", description: "Aloha and blue line pride. The Honolulu PD patch keychain brings island law enforcement representation to your keys or gear." },
  "houston-tx":               { name: "Houston Police Department", location: "Houston, TX", category: "Law Enforcement", description: "Houston PD — one of the largest municipal police departments in the United States. Texas pride on your keychain in full color." },
  "kent-pd":                  { name: "Kent Police Department", location: "Kent, WA", category: "Law Enforcement", description: "The Kent Police Department serves the third-largest city in Washington. This Pacific Northwest collector keychain is sharp and detailed." },
  "maricopa-pd":              { name: "Maricopa Police Department", location: "Maricopa, AZ", category: "Law Enforcement", description: "Maricopa PD serves the fast-growing Pinal County city south of Phoenix. This keychain is a standout collector piece for the Maricopa community." },
  "maricopa-sheriff":         { name: "Maricopa County Sheriff's Office", location: "Maricopa County, AZ", category: "Law Enforcement", description: "The MCSO gold star on blue — one of the largest sheriff's offices in the country. A collector staple for supporters of Arizona law enforcement." },
  "maui-pd":                  { name: "Maui Police Department", location: "Maui, HI", category: "Law Enforcement", description: "Serving the Valley Isle of Maui, Hawaii. The Maui PD patch keychain is a unique collector piece that brings island LE pride to the mainland and beyond." },
  "mesa-pd":                  { name: "Mesa Police Department", location: "Mesa, AZ", category: "Law Enforcement", description: "Mesa PD protects one of the largest cities in Arizona. This collector keychain features the Mesa PD patch in crisp UV-printed detail." },
  "nypd":                     { name: "New York City Police Department", location: "New York City, NY", category: "Law Enforcement", description: "The NYPD — the largest police department in the United States. An iconic collector piece representing New York's Finest." },
  "phoenix-pd":               { name: "Phoenix Police Department", location: "Phoenix, AZ", category: "Law Enforcement", description: "The Phoenix PD patch features the iconic firebird rising over the desert. As the fifth-largest city in the US, Phoenix PD is one of our most popular keychains." },
  "pinal-sheriff":            { name: "Pinal County Sheriff's Office", location: "Pinal County, AZ", category: "Law Enforcement", description: "The Pinal County Sheriff's Office gold star on black. A strong collector piece representing one of Arizona's most active sheriff's offices." },
  "prescott-pd":              { name: "Prescott Police Department", location: "Prescott, AZ", category: "Law Enforcement", description: "Serving Arizona's Mile High City. The Prescott PD patch keychain is a popular choice for officers and supporters in the Prescott area." },
  "queen-creek-pd":           { name: "Queen Creek Police Department", location: "Queen Creek, AZ", category: "Law Enforcement", description: "Queen Creek's rapidly growing Southeast Valley community is served by a dedicated police force. This keychain captures their patch in fine detail." },
  "san-jose-pd":              { name: "San Jose Police Department", location: "San Jose, CA", category: "Law Enforcement", description: "Silicon Valley's police force. The San Jose PD patch keychain represents California law enforcement pride in a compact, durable collector format." },
  "scottsdale-pd":            { name: "Scottsdale Police Department", location: "Scottsdale, AZ", category: "Law Enforcement", description: "Scottsdale PD serves The West's Most Western Town. A sleek, popular collector piece from the East Valley." },
  "seattle-pd":               { name: "Seattle Police Department", location: "Seattle, WA", category: "Law Enforcement", description: "Pacific Northwest law enforcement pride. The Seattle PD patch keychain is a bold collector piece for supporters of Washington state law enforcement." },
  "simi-valley-pd":           { name: "Simi Valley Police Department", location: "Simi Valley, CA", category: "Law Enforcement", description: "Serving Ventura County's largest city. The Simi Valley PD patch keychain is a standout collector piece for California LE supporters." },
  "tempe-pd":                 { name: "Tempe Police Department", location: "Tempe, AZ", category: "Law Enforcement", description: "Tempe PD serves the home of Arizona State University and major downtown entertainment districts. A vibrant patch and a popular keychain." },
  "tucson-pd":                { name: "Tucson Police Department", location: "Tucson, AZ", category: "Law Enforcement", description: "Old Pueblo pride. The Tucson PD patch keychain is a bold collector piece representing Southern Arizona's largest city police force." },
  "us-border-patrol":         { name: "U.S. Border Patrol", location: "Federal — Nationwide", category: "Law Enforcement", description: "Honoring the men and women of U.S. Customs and Border Protection. Federal law enforcement pride in a precision UV-printed collector keychain." },
  "harris-constable-pct4":    { name: "Harris County Constable Precinct 4", location: "Harris County, TX", category: "Law Enforcement", description: "Harris County Constable Precinct 4 serves the northwest Houston area. A Texas LE collector piece representing county-level law enforcement." },
  "ice":                      { name: "Immigration and Customs Enforcement", location: "Federal — Nationwide", category: "Law Enforcement", description: "Representing ICE federal law enforcement. A collector keychain for supporters of federal immigration and customs enforcement officers." },
  "flagstaff-pd-retired":     { name: "Flagstaff Police Department Retired", location: "Flagstaff, AZ", category: "Law Enforcement", description: "A career tribute for retired officers of Flagstaff PD. Serving Arizona's mountain city at 7,000 feet elevation — earned and deserved." },
  "austin-pd":                { name: "Austin Police Department", location: "Austin, TX", category: "Law Enforcement", description: "Keep Austin weird and keep it protected. The Austin PD patch keychain represents Texas's capital city law enforcement." },
  "oakland-pd":               { name: "Oakland Police Department", location: "Oakland, CA", category: "Law Enforcement", description: "The Oakland Police Department serves one of California's most diverse cities. A bold collector piece for Bay Area law enforcement supporters." },
  "birmingham-pd":            { name: "Birmingham Police Department", location: "Birmingham, AL", category: "Law Enforcement", description: "Alabama's largest city police department. The Birmingham PD patch keychain is a collector piece representing the Magic City's finest." },
  "pima-sheriff":             { name: "Pima County Sheriff's Office", location: "Pima County, AZ", category: "Law Enforcement", description: "The PCSO serves Tucson and all of Pima County. A standout collector piece representing Southern Arizona county-level law enforcement." },
  "flagstaff-pd":             { name: "Flagstaff Police Department", location: "Flagstaff, AZ", category: "Law Enforcement", description: "Serving Arizona's Mile High City year-round. The Flagstaff PD patch keychain is a crisp collector piece for Northern Arizona LE supporters." },
  "madison-pd":               { name: "Madison Police Department", location: "Madison, WI", category: "Law Enforcement", description: "Wisconsin's capital city police force. The Madison PD patch keychain is a detailed collector piece for Midwest law enforcement pride." },
  "texarkana-pd":             { name: "Texarkana Police Department", location: "Texarkana, TX/AR", category: "Law Enforcement", description: "The city that sits on two state lines — Texarkana PD serves a unique jurisdiction. A one-of-a-kind collector piece for a one-of-a-kind city." },
  "ohio-deputy-sheriff":      { name: "Ohio Deputy Sheriff", location: "Ohio", category: "Law Enforcement", description: "Representing Ohio county sheriffs across the state. A collector keychain for Ohio deputy sheriff supporters." },
  "avondale-pd":              { name: "Avondale Police Department", location: "Avondale, AZ", category: "Law Enforcement", description: "Avondale PD serves Arizona's growing West Valley community. A clean, detailed collector keychain for local LE supporters." },
  "arizona-rangers":          { name: "Arizona Rangers", location: "Arizona", category: "Law Enforcement", description: "The Arizona Rangers — a storied tradition in Western law enforcement. A unique collector piece for Arizona history and LE enthusiasts." },
  "harris-county-sheriff":    { name: "Harris County Sheriff's Office", location: "Harris County, TX", category: "Law Enforcement", description: "The Harris County Sheriff's Office serves greater Houston and is one of the largest sheriff's offices in the country. Texas pride." },
  "glendale-pd-az":           { name: "Glendale Police Department", location: "Glendale, AZ", category: "Law Enforcement", description: "Home of State Farm Stadium, Glendale PD serves one of Arizona's largest West Valley cities. A bold collector keychain." },
  "cochise-sheriff":          { name: "Cochise County Sheriff's Office", location: "Cochise County, AZ", category: "Law Enforcement", description: "Cochise County borders Mexico in Southeast Arizona — a uniquely demanding jurisdiction. A meaningful collector piece for supporters." },
  "buckeye-pd":               { name: "Buckeye Police Department", location: "Buckeye, AZ", category: "Law Enforcement", description: "One of Arizona's fastest-growing cities. Buckeye PD is an expanding force serving the far West Valley and this keychain captures their patch in detail." },
  "asu-pd":                   { name: "Arizona State University Police Department", location: "Tempe, AZ", category: "Law Enforcement", description: "Protecting the largest public university in the US. The ASU PD patch keychain is a popular item for Sun Devils and university LE supporters." },
  "detroit-pd":               { name: "Detroit Police Department", location: "Detroit, MI", category: "Law Enforcement", description: "Motor City pride and blue line dedication. The Detroit PD patch keychain represents one of America's most storied police departments." },
  "santa-fe-pd":              { name: "Santa Fe Police Department", location: "Santa Fe, NM", category: "Law Enforcement", description: "Protecting New Mexico's capital city and its rich cultural heritage. The Santa Fe PD patch keychain is a colorful collector piece." },
  "apache-junction-pd":       { name: "Apache Junction Police Department", location: "Apache Junction, AZ", category: "Law Enforcement", description: "Serving the gateway to the Superstition Mountains. The Apache Junction PD patch keychain is a standout Arizona collector piece." },
  "peoria-pd-az":             { name: "Peoria Police Department", location: "Peoria, AZ", category: "Law Enforcement", description: "Peoria PD serves Arizona's sixth-largest city. A clean, detailed collector keychain representing this growing North Valley community." },
  "auburn-pd":                { name: "Auburn Police Department", location: "Auburn, WA", category: "Law Enforcement", description: "Auburn PD serves one of Washington's larger cities between Seattle and Tacoma. A solid Pacific Northwest law enforcement collector piece." },
  "maricopa-detention-deputy":{ name: "MCSO Detention Deputy", location: "Maricopa County, AZ", category: "Corrections", description: "The Maricopa County Sheriff's Office Detention Division — corrections professionals who are often overlooked but never forgotten." },
  "az-doc":                   { name: "Arizona Department of Corrections", location: "Arizona", category: "Corrections", description: "Honoring Arizona corrections officers who keep facilities safe and secure every day. A collector piece for a profession that deserves more recognition." },
  "az-doc-logo":              { name: "Arizona Dept. of Corrections Logo", location: "Arizona", category: "Corrections", description: "The ADOC logo edition — a clean and bold collector keychain for Arizona corrections supporters." },
  "101st-airborne":           { name: "101st Airborne Division — Screaming Eagles", location: "Ft. Campbell, KY", category: "Military", description: "Air Assault. The 101st Airborne Screaming Eagles are one of the most decorated divisions in U.S. Army history. A must-have military collector keychain." },
  "10th-mountain":            { name: "10th Mountain Division", location: "Ft. Drum, NY", category: "Military", description: "Climb to Glory. The 10th Mountain Division has served in every major conflict since WWII. A powerful collector piece for Army veterans and military families." },
  "173rd-airborne":           { name: "173rd Airborne Brigade — Sky Soldiers", location: "Vicenza, Italy", category: "Military", description: "Sky Soldiers. The 173rd Airborne Brigade is the U.S. Army's rapid deployment force in Europe. A sharp collector keychain for airborne supporters." },
  "504th-pir-ww2":            { name: "504th Parachute Infantry Regiment — WW2", location: "Historical — U.S. Army", category: "Military", description: "Devil in Baggy Pants. The 504th PIR earned this nickname from a captured German officer's diary. A historic WWII tribute collector keychain." },
  "82nd-airborne":            { name: "82nd Airborne Division", location: "Ft. Bragg (Ft. Liberty), NC", category: "Military", description: "All American. The 82nd Airborne is the premier airborne division of the U.S. Army — always ready to deploy within 18 hours notice. A collector classic." },
  "seabees":                  { name: "U.S. Naval Construction Battalions — Seabees", location: "U.S. Navy", category: "Military", description: "We Build, We Fight. The Navy Seabees have constructed bases and fortifications in every theater of war since WWII. A proud veteran collector keychain." },
  "75th-ranger-regiment":     { name: "75th Ranger Regiment", location: "Ft. Benning (Ft. Moore), GA", category: "Military", description: "Rangers Lead the Way. The 75th Ranger Regiment is the Army's premier direct action raid force. A bold and recognizable collector keychain." },
  "us-air-force":             { name: "United States Air Force", location: "U.S. Air Force", category: "Military", description: "Aim High, Fly, Fight, Win. Representing the men and women of the United States Air Force in a precision UV-printed collector keychain." },
  "3rd-battalion-7th-marines":{ name: "3rd Battalion 7th Marines", location: "U.S. Marine Corps", category: "Military", description: "Cutting Edge. The 3/7 Marines are a light armored reconnaissance battalion with a proud combat lineage. A collector piece for Marine supporters." },
  "army-ranger-medic":        { name: "Army Ranger Medic", location: "U.S. Army", category: "Military", description: "The most skilled battlefield medics in the world. Army Ranger Medics carry both tabs and the skills to keep Rangers in the fight." },
  "chandler-fire":            { name: "Chandler Fire Department", location: "Chandler, AZ", category: "Fire", description: "The Chandler Fire Department protects one of Arizona's fastest-growing cities. A sharp collector keychain for firefighters and fire service supporters." },
  "phoenix-fire":             { name: "Phoenix Fire Department", location: "Phoenix, AZ", category: "Fire", description: "Protecting the fifth-largest city in the country, Phoenix Fire is one of the most active urban fire departments in the Southwest. A bold collector piece." },
  "mammoth-fire":             { name: "Mammoth Fire Department", location: "Mammoth Lakes, CA", category: "Fire", description: "Serving one of California's most iconic mountain resort communities. The Mammoth Fire Department patch keychain is a unique collector item." },
  "amr-emt":                  { name: "AMR Emergency Medical Technician", location: "American Medical Response", category: "EMS", description: "American Medical Response EMTs are on the front lines of emergency medicine across the country. This keychain honors their service every shift." },
  "amr-paramedic":            { name: "AMR Paramedic", location: "American Medical Response", category: "EMS", description: "AMR Paramedics provide advanced life support in emergency situations. A collector piece for the EMS professionals who run toward the call." },
  "amr-cct-rn":               { name: "AMR Critical Care Transport RN", location: "American Medical Response", category: "EMS", description: "Critical Care Transport RNs are the highest level of pre-hospital care providers. This keychain recognizes their advanced training and dedication." },
  "pink-patch":               { name: "Pink Patch Project", location: "Nationwide", category: "Pink Patch", description: "Police patches gone pink for breast cancer awareness. A portion of every Pink Patch sale is donated to breast cancer research. Wear pink, carry awareness." },
  "chandler-pd-pink":         { name: "Chandler PD — Pink Patch Project", location: "Chandler, AZ", category: "Pink Patch", description: "Chandler PD goes pink for breast cancer awareness. Our most popular Pink Patch keychain — 10% of every sale donated to breast cancer research." },
  "pomona-pink-patch":        { name: "Pomona Police — Pink Patch Project", location: "Pomona, CA", category: "Pink Patch", description: "Pomona PD joins the Pink Patch Project. A California law enforcement awareness keychain with 10% of proceeds going to breast cancer research." }
});
...
async function initProductPage() {
  ...
  const description = data.description || "UV-printed 3D patch keychain, handcrafted in the USA.";
